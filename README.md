...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
    ...
    /* Modal */
    #withdraw-modal { display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.8); justify-content:center; align-items:center; z-index:999; }
    #withdraw-modal .modal-content { background:var(--card-bg); padding:20px; border-radius:16px; width:90%; max-width:350px; color:var(--text-color); display:flex; flex-direction:column; }
    #withdraw-modal input, #withdraw-modal select { width:100%; padding:10px; margin-bottom:15px; border-radius:8px; border:none; background:#111; color:#e0ffe0; }
    #withdraw-modal button { padding:10px; border:none; border-radius:12px; font-weight:700; cursor:pointer; }
    #withdraw-modal .submit-btn { background:var(--primary-color); color:#000; margin-bottom:8px; }
    #withdraw-modal .cancel-btn { background:#222; color:#fff; }
  </style>
  ...
  <div class="container">
    <main>
      ...
      <div id="home-view" class="view active">
        ...
        <div class="task-card" onclick="requestWithdrawal()">
          <div class="task-icon"><i class="fa-solid fa-money-bill"></i></div>
          <div class="task-details">
            <h3>Withdraw</h3>
            <p>Withdraw your balance via bKash or Nagad.</p>
          </div>
          <div class="task-arrow"><i class="fa-solid fa-chevron-right"></i></div>
        </div>
      </div>
